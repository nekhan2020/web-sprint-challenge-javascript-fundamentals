...
// nestedFunction and const internal are both within the scope of myFunction so they both exist locally within the scope of myFunction - the invocation of nestedFunction requires a variable called internal and since it is not within the scope of nestedFunction itself - javascript searches outside of it to find the variable internal which causes a closure but javascript does find the variable value and returns it to the nestedFunction to complete the function
